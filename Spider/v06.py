...
4.利用NetWork-All-Heardes，查看·发现FormData的值是kw:girl
...
req = request.Request(url=basurl, data=data, headers=headers)
# 因为已经构造了一个Request的请求是路，则所有的请求信息都可以封装在Request实例中
